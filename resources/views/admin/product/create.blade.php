        ...
        <form action="{{route('admin.products.store')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="number" name="original_price" class="form-control  border border-dark">
            </div>
            <div class="col-md-6 mb-3">
              <label for="">Selling Price</label>
              <input type="number" name="selling_price" class="form-control  border border-dark">
            </div>
            <div class="col-md-6 mb-3">
              <label for="">Tax</label>
              <input type="number" name="tax" class="form-control  border border-dark">
            </div>
            <div class="col-md-6 mb-3">
              <label for="">Quantity</label>
              <input type="number" name="qty" class="form-control  border border-dark">
            </div>
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-12 mb-3">
              ...
              <textarea name="meta_keywords" rows="3" class="form-control  border border-dark"></textarea>          
            </div>
            <div class="col-md-12 mb-3">
            ...
            <div class="col-md-12">
              <input type="file" class="form-control  border border-dark" name="image">
            </div>
